    ...
    public void onMethodCall(@NonNull MethodCall call, @NonNull MethodChannel.Result result) {
        switch (call.method) {
            ...
            case OPEN_DOCUMENT:
                ...
                Log.e("SDL3", TextDecryptionUtils.decrypt(password));
                intent.putExtra(CPDFDocumentActivity.EXTRA_FILE_PASSWORD, !password.isEmpty() ? TextDecryptionUtils.decrypt(password): password);
